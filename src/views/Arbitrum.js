      ...
      <div className="chart-grid">
        ...
        <div className="chart-cell">
          <GenericChart
            ...
            description="Formula = Daily Fees / OLP Pool * 365 days * 100"
            type="Composed"
          />
        </div>
        <div className="chart-cell">
          <GenericChart
            ...
            description="Formula = Daily Volume / OLP Pool * 100"
            type="Composed"
          />
        </div>
        <div className="chart-cell">
        ...
        <div className="chart-cell">
          <GenericChart
            ...
            tooltipFormatter={tooltipFormatterNumber}
            tooltipLabelFormatter={tooltipLabelFormatterUnits}
            items={[{ key: 'actionSwapCount', name: 'Swaps' }, { key: 'actionMarginCount', name: 'Margin trading' }, { key: 'actionMintBurnCount', name: 'Mint & Burn OLP' }]}
            type="Composed"
          />
        </div>
        <div className="chart-cell">
