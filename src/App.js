...
import darkLogoIcon from './img/omnidex_logo.png';
import lightLogoIcon from './img/omnidex_logo_dark.png';
        ...
        mode && <div className={cx("App", mode)}>
          ...
          <div className="nav">
            <div className="nav-left">
              ...
              <a href="https://omnidex.finance" target="_blank" className="nav-logo">
                <img width="87" src={mode == 'dark' ? darkLogoIcon : lightLogoIcon} />
              </a>
              <NavLink to="/" exact className="nav-link" activeClassName="active">Telos</NavLink>
              {/* <NavLink to="/avalanche" className="nav-link">Avalanche</NavLink> */}
            </div>
            <div className="nav-right">
              <a href="https://omnidex.finance" target="_blank" className="nav-link">APP</a>
              <a href="https://docs.omnidex.finance" target="_blank" className="nav-link">DOCS</a>
