...
const providers = {
  arbitrum: new JsonRpcProvider('https://mainnet.telos.net/evm'),
...
export async function queryEarnData(chainName, account) {
  ...
  if (chainId === ARBITRUM) {
    // GMX, EsGMX, stakedGMXTracker, bonusGMXTracker
    depositTokens = ['0xd2504a02fABd7E546e41aD39597c377cA8B0E1Df', '0xCE874A4333b9B5bBC3986Eb73C382A01330C8CaE', '0x260A11E45F64F74A198Bdf80f91eEe924a38177c', '0xD3a6A77d0C5d9F80A56EBE7F019e36eCE9743923', '0x433cFc86dEC7A73DDFeD359c96DE683A389F1343', '0x96535E6ecF23Ba183248E0fC653361F5920F171D']
    rewardTrackersForDepositBalances = ['0x260A11E45F64F74A198Bdf80f91eEe924a38177c', '0x260A11E45F64F74A198Bdf80f91eEe924a38177c', '0xD3a6A77d0C5d9F80A56EBE7F019e36eCE9743923', '0x6592578F00bf088ba357C721D342eD030ED51a99', '0x6592578F00bf088ba357C721D342eD030ED51a99', '0x86baFb407a078Ac5D125228e3DFCD4956455C36f']
    rewardTrackersForStakingInfo = ['0x260A11E45F64F74A198Bdf80f91eEe924a38177c', '0xD3a6A77d0C5d9F80A56EBE7F019e36eCE9743923', '0x6592578F00bf088ba357C721D342eD030ED51a99', '0x207a1491aD1DF38c76F1Dc3770e1F0EBB77768c0', '0x86baFb407a078Ac5D125228e3DFCD4956455C36f']
  } else {
...
export const tokenDecimals = {
  "0xfa9343c3897324496a05fc75abed6bac29f8a40f": 18, // WETH
  "0xf390830df829cf22c53c8840554b98eafc5dcbc2": 8, // BTC
  "0x818ec0a7fe18ff94269904fced6ae3dae6d6dc0b": 6, // USDC
  "0xfa7f8980b0f1e64a2062791cc3b0871572f1f7f0": 18, // UNI
  "0xefaeee334f0fd1712f9a8cc375f427d9cdd40d73": 6, // USDT
  "0xD102cE6A4dB07D247fcc28F366A623Df0938CA9E": 18, // LINK
...
export const tokenSymbols = {
  ...
  '0xD102cE6A4dB07D247fcc28F366A623Df0938CA9E': 'LINK',
...
const knownSwapSources = {
  arbitrum: {
    '0x36612DC61AdFCbA2dD30def8d9fAB92aCDEEb7ca': 'GMX Router', // Router
    '0x387e9d87BE0900018766B94e3c232564DfA5C308': 'GMX OrderBook', // Orderbook
    '0x2EA440024BAE65e655E9ec8AC596d02FBC3Db1c2': 'GMX PositionManager A', // PositionManager old
    '0x2EA440024BAE65e655E9ec8AC596d02FBC3Db1c2': 'GMX PositionManager B', // PositionManager
    '0x2EA440024BAE65e655E9ec8AC596d02FBC3Db1c2': 'GMX PositionManager C', // PositionManager 12 oct 2022
    '0x54f84b61Ec4f1950954eBD03aE2c22bd1C2A11A7': 'GMX PositionRouter C', // PositionRouter 12 oct 2022
    '0x7257ac5d0a0aac04aa7ba2ac0a6eb742e332c3fb': 'GMX OrderExecutor', // OrderExecutor ???
    '0xAFE63F26E69e41374a96A9a0bB109BfF9Fce782d': 'GMX FastPriceFeed A', // FastPriceFeed
...
export function useGraph(querySource, { subgraph = null, subgraphUrl = null, chainName = "arbitrum" } = {}) {
  ...
  if (!subgraphUrl) {
    ...
    subgraphUrl = `https://subgraph.omnidex.finance/subgraphs/name/${subgraph}`;
  }
